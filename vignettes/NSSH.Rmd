...
if (!dir.exists(file.path(find.package("SoilKnowledgeBase"), "inst", "extdata"))) {
  dir.create(file.path(find.package("SoilKnowledgeBase"), "inst", "extdata"), recursive = TRUE)
}

skb_path <- system.file("inst", "extdata", package = "SoilKnowledgeBase")
