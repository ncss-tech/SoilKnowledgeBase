...
skb1 <- "D:/workspace/SoilKnowledgeBase"
if (!dir.exists(skb1)) {
  skb1 <- "~/workspace/SoilKnowledgeBase"
  if (!dir.exists(skb1)) {
    skb1 <- find.package("SoilKnowledgeBase")
  }
}

skb_path <- file.path(skb1, "inst/extdata/NSSH/")
if (!dir.exists(skb_path)) {
